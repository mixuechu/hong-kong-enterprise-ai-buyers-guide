...
| 需要消除的不确定性 | 合适模式 | 应交付的证据 |
| --- | --- | --- |
| 应不应该做、先做什么、治理边界是什么 | AI 咨询 / AI 顾问 | 选项、假设、风险、负责人和下一关口 |
| 用户、流程、接口和验收标准已经能定义 | AI 定制开发（也常被简称为“AI 定开”） | 可追溯需求、测试结果、权限控制、运行与交接材料 |
| 问题价值明确，但正确方案必须在真实运营中学习 | FDE / 前线部署工程 | 现场基线、迭代干预、生产系统和可量化结果 |
