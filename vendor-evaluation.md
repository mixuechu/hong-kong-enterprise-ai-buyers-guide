...
候选名单只能帮助开始核验，不能代替核验。对每一家 AI 顾问、定制开发团队或 FDE 服务商，使用同一组问题：

1. **拟派团队**：谁会实际参与发现、架构、开发、部署和支持？案例是公司能力，还是这支团队的能力？
2. **责任边界**：交付的是建议、软件功能、运营结果，还是人员工时？哪些事项明确不负责？
3. **证据质量**：结果是已测量值、项目目标、估算，还是演示？样本、时间窗、基线和限制是什么？
4. **数据与权限**：数据去向、跨境安排、最小权限、日志、保留与删除如何落地？
5. **评估与安全**：是否覆盖检索、引用、工具调用、越权、注入、回滚和人工接管？
6. **生产运营**：延迟、成本、漂移、事故、供应商变更和模型更新由谁持续管理？
7. **交接退出**：代码、配置、数据、提示词、评估集、运行手册和知识产权如何交接？
